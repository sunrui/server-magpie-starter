...
@NoArgsConstructor
@AllArgsConstructor
public class SponsorPublish extends MagpieEntity {
    /**
     * 投放状态
     */
    public enum Status {
    ...
    @JoinColumn
    @ManyToOne
    private SpecQuote specQuote;
    @ApiModelProperty(value="上传的物料信息")
    @OneToMany
    private List<SponsorPublishMaterials> sponsorPublishMaterials;
    @ApiModelProperty(value="投放期数下的广告主", required = true)
    @NotNull
    @OneToOne
    private SponsorPublish sponsorPublish;
