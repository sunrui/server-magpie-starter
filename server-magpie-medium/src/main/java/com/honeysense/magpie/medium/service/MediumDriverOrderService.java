...
public interface MediumDriverOrderService extends MagpieChannelUserManyService<MediumDriverOrder> {
    ...
    MagpiePage<MediumDriverOrder> findAllByChannelIdAndUserIdAndOrderStatusNotIn(Long channelId, Long userId, MediumDriverOrderStatus[] statuses, MagpiePageRequest magpiePageRequest);
}
